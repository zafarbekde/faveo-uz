      ...
      <div className="wrapper">
        <div className="dashboard">
          <ul className="dashboard-list">
            <li onClick={() => handleTabClick("Manage Users")} className="list-item"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="users w-6 h-6">
